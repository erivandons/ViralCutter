...
def edit_single_file(input_file, project_folder, face_model, face_mode, detection_period, 
    ...
    # Fallback to MediaPipe/Haar if needed (Simplified for now, focusing on InsightFace optimization)
    if not success:
         # Simplified fallback to center crop zoom to ensure robustness in parallel flow
